...
export default function SignUp() {
  return (
    <section className="relative w-full py-24 overflow-hidden bg-[#CFCFCF]">
    
      <div className="relative max-w-7xl mx-auto px-6 lg:px-12 flex flex-col md:flex-row items-center gap-16">
        {/* Left Content */}
        <div className="w-full md:w-1/2 space-y-8 text-center md:text-left">
          <span className="inline-block px-5 py-1 text-sm font-semibold text-[#0443f2] bg-[#53cbfb]/20 rounded-full shadow-sm">
            Stay Ahead
          </span>

          <h2 className="text-4xl md:text-5xl font-extrabold text-[#040404] leading-tight">
            Get job <span className="text-[#53cbfb]">alerts</span> <br className="hidden md:block" /> straight to your
            inbox
          </h2>

          <p className="text-[#040404] text-lg max-w-md mx-auto md:mx-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            <Link
              ...
              className="relative px-8 py-3 rounded-lg border border-[#53cbfb] text-[#53cbfb] font-medium overflow-hidden group transition-all duration-500"
            >
        ...
        <div className="w-full md:w-1/2 flex justify-center relative ">
          <div className="relative z-10">
            ...
            />
            {/* Floating Glow */}
            <div className="absolute -inset-4 bg-gradient-to-r from-[#53cbfb]/20 to-[#0443f2]/10 rounded-2xl opacity-20 blur-2xl"></div>
          </div>
        </div>
      </div>
    </section>
