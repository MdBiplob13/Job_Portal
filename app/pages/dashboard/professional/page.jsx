      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        >
          ...
          {completedJobs.map((job, i) => (
            <div
              key={i}
              className="space-y-4 p-4 bg-linear-to-r from-gray-50 to-white rounded-xl border border-gray-200"
            >
              ...
              <button className="w-full bg-linear-to-r from-[#D90A2C] to-red-600 text-white py-3 rounded-xl font-semibold hover:shadow-lg transition-all">
                Rate The Employer
              </button>
            </div>
          ))}
