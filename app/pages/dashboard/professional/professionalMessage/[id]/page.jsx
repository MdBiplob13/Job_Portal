...
export default function ProfessionalMessageSinglePage() {
  ...
  // Handle URL-based user selection
  useEffect(() => {
    const handleUrlUserSelection = () => {
      ...
      if (existingContact) {
        ...
        const newContact = {
          ...
          job: singleUser.headline || singleUser.currentPosition || singleUser.job || "No job specified",
          message: "Start a conversation",
          time: "Just now",
          unread: 0,
          lastSeen: "Recently",
          rating: singleUser.review?.rating || 0,
  ...
  }, [id, contacts, singleUser, singleUserLoading, user, isLoadingContacts]);
