    ...
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100 p-6">
      ...
      <div className="mb-8">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
          ...
          <Link href={'/pages/dashboard/employer/post/bids'} className="bg-blue-500 text-white px-6 py-3 rounded-xl font-semibold hover:bg-primary transition-colors flex items-center gap-2 w-fit cursor-pointer">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        {filteredBids.length === 0 ? (
          <div className="col-span-2 bg-white rounded-2xl p-12 text-center border border-gray-200">
            ...
            <Link href={'/pages/dashboard/employer/post/bids'} className="bg-blue-500 text-white px-6 py-2 rounded-lg font-semibold hover:bg-primary transition-colors inline-block">
              Post New Bids
            </Link>
          </div>
        ) : (
