        ...
        <div className="relative -top-16 px-6">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
            <div className="flex flex-col lg:flex-row items-start gap-8">
              {/* Profile Photo */}
              <div className="relative -top-20 lg:-top-0 lg:flex-shrink-0">
                <div className="relative">
              ...
              <div className="space-y-6">
                {profileData.experience
                  ...
                  .map((exp) => (
                    ...
                    >
                      <div className="w-12 h-12 bg-blue-500 rounded-xl flex items-center justify-center text-white font-bold flex-shrink-0">
