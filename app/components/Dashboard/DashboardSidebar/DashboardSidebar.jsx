...
import { FiHome, FiSearch, FiBriefcase, FiMessageCircle, FiDollarSign, FiUser, FiLogOut } from "react-icons/fi";
            ...
            {menuItems.map((item) => (
              <li key={item.id}>
                <button
                  ...
                  className={`flex items-center w-full p-3 rounded-lg text-gray-700 hover:bg-blue-50 hover:text-blue-600 ${
